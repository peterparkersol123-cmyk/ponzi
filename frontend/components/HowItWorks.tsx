...
const STEPS = [
  ...
  "each recorded buy resets a 60-second deadline; when it lapses, settle() is permissionless — anyone, including the winner, can trigger it, and it pays the full pool to the last recorded buyer in one transaction",
